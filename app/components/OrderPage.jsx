...
export default function OrderPage () {
  ...
  const onSubmitOrder = () => {
    ...
    if (shippingInfo) {
      ...
      doc.setFont('helvetica', 'normal')
      doc.text(
        `Order Number: ${shippingInfo?.orderNumber}${shippingInfo?.serialnumber}`,
        10,
              ...
              <div className='flex flex-wrap'>
                ...
                >
                  <div>
                    ...
                    <br />
                    <br />
                    <h6 className='text-2xl font-text font-bold'>
                    ...
                    <div className='container px-10 mx-0 min-w-full flex flex-col items-center'>
                      <button
                        onClick={onSubmitOrder}
                        className='mt-3 bg-red-700 text-white hover:bg-black font-bold py-2 px-10 rounded flex items-center justify-center'
                      >
                        <FaLongArrowAltLeft
                          size={20}
